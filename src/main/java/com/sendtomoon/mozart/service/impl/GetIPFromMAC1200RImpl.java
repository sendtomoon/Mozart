	...
	public void getIP() {
		try {
			Map<String, Object> getStok = httpClient.getHttpClient("http://192.168.0.1/",
					"{\"method\":\"do\",\"login\":{\"password\":\"WrLio6Kc9TefbwK\"}}", null, null, "POST");
			Map stok = (Map) JSON.parse(getStok.get("responseMsg").toString());
			Map<String, Object> header = new HashMap<String, Object>();
			header.put("Accept", "application/json, text/plain, */*");
			header.put("Content-Type", "application/json");
			Map getIP = httpClient.getHttpClient("http://192.168.0.1/stok=" + stok.get("stok").toString() + "/ds",
					"{\"network\":{\"name\":\"wan_status\"},\"method\":\"get\"}", header, null, "POST");
			...
			httpClient.getHttpsClient("https://api.godaddy.com/v1/domains/sendtomoon.com/records/A/mozart", requestBody,
					godaddyHeader, "PUT");
		} catch (Exception e) {
			e.printStackTrace();
		}
